...
_Public domain text by William Strunk Jr. Vendored from the
elements-of-style plugin (obra/elements-of-style) so the marketing flow
can require it unconditionally._
